...
await page.goto("http://127.0.0.1:8060/www/?demo=MIMEcroft.sh%20--demo", { waitUntil: "load", timeout: 60000 });
...
console.log("demo GAME DONE:", t.includes("GAME DONE"), "| stats:", t.includes("#stats:"));
await browser.close();
